...
#let triole_note_symbol = box[#move(dy: 0.3mm, stack(
  dir: ttb,
  spacing: -0.35em,
  align(center)[#box[#move(dy: -3.3mm, text(size: 8pt, font: ("Noto Music", "Libertinus Serif"))[┌──3──┐])]],
  align(center)[#text(size: 12pt, font: "Noto Music")[𝅘𝅥𝅮𝅘𝅥𝅮𝅘𝅥𝅮]],
))]
...
#let duration_table = table(
  ...
  [#align(center + horizon, [#box([#move(dy: -0.6mm, [#achtel_note_symbol#h(0.5mm)/#achtel_beam/#h(0.5mm)#achtel_pause_symbol])])])], [Achtelnote], [$1/2$ = 2x Sechzehntel], [1-und 2-und...], [...erstem "und"],
  [#align(center + horizon, [#box([#move(dy: -0.6mm, [#sechzehntel_note_symbol#h(0.5mm)/#sechzehntel_beam/#h(0.5mm)#sechzehntel_pause_symbol])])])], [Sechzehntel], [$1/4$], [1-e-und-a 2...], [..."e"],
  [#align(center + horizon, [#box([#punktierte_viertel_note_symbol#h(0.6mm)/#punktierte_bindung_symbol/#h(0.6mm)#punktierte_viertel_pause_symbol])])], [Punktierte\ Viertel], [$1 1/2$ = Viertel + Achtel\ Punkt = +50% des Notenwerts], [1-und 2-und...], [...zweitem "und"],
